...
function getHeader(instanceId, api) {
    ...
    ]).pipe((0, rxjs_1.switchMap)(([header, queryAt]) => (0, util_js_1.getAuthorDetails)(header, queryAt)), (0, rxjs_1.map)(([header, validators, author]) => (0, index_js_1.createHeaderExtended)((validators || header).registry, header, validators, author))));
}
