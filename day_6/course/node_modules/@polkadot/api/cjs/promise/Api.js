...
class ApiPromise extends index_js_1.ApiBase {
    ...
    constructor(options) {
        ...
        tslib_1.__classPrivateFieldSet(this, _ApiPromise_isReadyPromise, new Promise((resolve) => {
            super.once('ready', () => resolve(this));
        }), "f");
        tslib_1.__classPrivateFieldSet(this, _ApiPromise_isReadyOrErrorPromise, new Promise((resolve, reject) => {
     ...
     */
    get isReady() {
        return tslib_1.__classPrivateFieldGet(this, _ApiPromise_isReadyPromise, "f");
    }
    /**
     * @description Promise that resolves if we can connect, or reject if there is an error
     */
    get isReadyOrError() {
        return tslib_1.__classPrivateFieldGet(this, _ApiPromise_isReadyOrErrorPromise, "f");
    }
    /**
