...
class Init extends Decorate_js_1.Decorate {
    constructor(options, type, decorateMethod) {
        ...
        if (!options.source) {
            ...
            tslib_1.__classPrivateFieldSet(this, _Init_registries, tslib_1.__classPrivateFieldGet(options.source, _Init_registries, "f"), "f");
        }
        ...
        if (this.hasSubscriptions) {
            this._rpcCore.provider.on('disconnected', () => tslib_1.__classPrivateFieldGet(this, _Init_instances, "m", _Init_onProviderDisconnect).call(this));
            this._rpcCore.provider.on('error', (e) => tslib_1.__classPrivateFieldGet(this, _Init_instances, "m", _Init_onProviderError).call(this, e));
            this._rpcCore.provider.on('connected', () => tslib_1.__classPrivateFieldGet(this, _Init_instances, "m", _Init_onProviderConnect).call(this));
        }
        ...
        if (this._rpcCore.provider.isConnected) {
            ...
            tslib_1.__classPrivateFieldGet(this, _Init_instances, "m", _Init_onProviderConnect).call(this);
        }
    }
    /**
    ...
    _initRegistry(registry, chain, version, metadata, chainProps) {
        ...
        registry.setMetadata(metadata, undefined, (0, util_1.objectSpread)({}, (0, types_known_1.getSpecExtensions)(registry, chain, version.specName), this._options.signedExtensions));
    }
    /**
     * @description Returns the default versioned registry
     */
    _getDefaultRegistry() {
        return (0, util_1.assertReturn)(tslib_1.__classPrivateFieldGet(this, _Init_registries, "f").find(({ isDefault }) => isDefault), 'Initialization error, cannot find the default registry');
    }
    /**
    ...
    async at(blockHash, knownVersion) {
        ...
        if (!tslib_1.__classPrivateFieldGet(this, _Init_atLast, "f") || tslib_1.__classPrivateFieldGet(this, _Init_atLast, "f")[0] !== u8aHex) {
            // always create a new decoration - since we are pointing to a specific hash, this
            // means that all queries needs to use that hash (not a previous one already existing)
            tslib_1.__classPrivateFieldSet(this, _Init_atLast, [u8aHex, this._createDecorated(registry, true, null, u8aHash).decoratedApi], "f");
        }
        return tslib_1.__classPrivateFieldGet(this, _Init_atLast, "f")[1];
    }
    async _createBlockRegistry(blockHash, header, version) {
        ...
        tslib_1.__classPrivateFieldGet(this, _Init_registries, "f").push(result);
        return result;
    }
    _cacheBlockRegistryProgress(key, creator) {
        // look for waiting resolves
        let waiting = tslib_1.__classPrivateFieldGet(this, _Init_waitingRegistries, "f")[key];
        if ((0, util_1.isUndefined)(waiting)) {
            // nothing waiting, construct new
            waiting = tslib_1.__classPrivateFieldGet(this, _Init_waitingRegistries, "f")[key] = new Promise((resolve, reject) => {
                creator()
                    .then((registry) => {
                    delete tslib_1.__classPrivateFieldGet(this, _Init_waitingRegistries, "f")[key];
                    resolve(registry);
                })
                    .catch((error) => {
                    delete tslib_1.__classPrivateFieldGet(this, _Init_waitingRegistries, "f")[key];
    ...
    _getBlockRegistryViaVersion(blockHash, version) {
        if (version) {
            ...
            const existingViaVersion = tslib_1.__classPrivateFieldGet(this, _Init_registries, "f").find(({ runtimeVersion: { specName, specVersion } }) => specName.eq(version.specName) &&
    ...
    async getBlockRegistry(blockHash, knownVersion) {
        ...
        tslib_1.__classPrivateFieldGet(this, _Init_registries, "f").find(({ lastBlockHash }) => lastBlockHash && (0, util_1.u8aEq)(lastBlockHash, blockHash)) ||
            // try to find via version
    ...
    _subscribeUpdates() {
        if (tslib_1.__classPrivateFieldGet(this, _Init_updateSub, "f") || !this.hasSubscriptions) {
            return;
        }
        tslib_1.__classPrivateFieldSet(this, _Init_updateSub, this._rpcCore.state.subscribeRuntimeVersion().pipe((0, rxjs_1.switchMap)((version) => 
    ...
    async _metaFromChain(optMetadata) {
        ...
        if (!tslib_1.__classPrivateFieldGet(this, _Init_registries, "f").length) {
            tslib_1.__classPrivateFieldGet(this, _Init_registries, "f").push({ counter: 0, isDefault: true, metadata, registry: this.registry, runtimeVersion });
        }
    ...
    _subscribeHealth() {
        ...
        tslib_1.__classPrivateFieldSet(this, _Init_healthTimer, this.hasSubscriptions
            ? setInterval(() => {
    ...
    _unsubscribeHealth() {
        if (tslib_1.__classPrivateFieldGet(this, _Init_healthTimer, "f")) {
            clearInterval(tslib_1.__classPrivateFieldGet(this, _Init_healthTimer, "f"));
            tslib_1.__classPrivateFieldSet(this, _Init_healthTimer, null, "f");
        }
    }
    _unsubscribeUpdates() {
        if (tslib_1.__classPrivateFieldGet(this, _Init_updateSub, "f")) {
            tslib_1.__classPrivateFieldGet(this, _Init_updateSub, "f").unsubscribe();
            tslib_1.__classPrivateFieldSet(this, _Init_updateSub, null, "f");
        }
    }
    _unsubscribe() {
        this._unsubscribeHealth();
