...
class GenericSignerPayload extends types_codec_1.Struct {
    constructor(registry, value) {
        ...
        tslib_1.__classPrivateFieldSet(this, _GenericSignerPayload_extraTypes, {}, "f");
        const getter = (key) => this.get(key);
        // add all extras that are not in the base types
        for (const [key, type] of Object.entries(extensionTypes)) {
            if (!knownTypes[key]) {
                tslib_1.__classPrivateFieldGet(this, _GenericSignerPayload_extraTypes, "f")[key] = type;
            }
    ...
    toPayload() {
        const result = {};
        const keys = Object.keys(tslib_1.__classPrivateFieldGet(this, _GenericSignerPayload_extraTypes, "f"));
