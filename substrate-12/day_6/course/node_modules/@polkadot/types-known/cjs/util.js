...
const index_js_1 = tslib_1.__importDefault(require("./chain/index.js"));
const index_js_2 = tslib_1.__importDefault(require("./spec/index.js"));
const index_js_3 = tslib_1.__importDefault(require("./upgrades/index.js"));
/**
...
function getSpecTypes({ knownTypes }, chainName, specName, specVersion) {
    ...
    (0, util_1.objectSpread)({}, filterVersions(index_js_2.default[s], _specVersion), filterVersions(index_js_1.default[c], _specVersion), filterVersions(knownTypes.typesBundle?.spec?.[s]?.types, _specVersion), filterVersions(knownTypes.typesBundle?.chain?.[c]?.types, _specVersion), knownTypes.typesSpec?.[s], knownTypes.typesChain?.[c], knownTypes.types));
}
...
function getUpgradeVersion(genesisHash, blockNumber) {
    const known = index_js_3.default.find((u) => genesisHash.eq(u.genesisHash));
    return known
        ? [
