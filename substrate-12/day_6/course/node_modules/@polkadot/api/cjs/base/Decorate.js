...
class Decorate extends Events_js_1.Events {
    ...
    constructor(options, type, decorateMethod) {
        ...
        tslib_1.__classPrivateFieldSet(this, _Decorate_instanceId, `${++instanceCounter}`, "f");
        tslib_1.__classPrivateFieldSet(this, _Decorate_registry, options.source?.registry || options.registry || new types_1.TypeRegistry(), "f");
        ...
        this._rx.registry = tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f");
        ...
        this._rpcCore = new rpc_core_1.RpcCore(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f"), thisProvider, this._options.rpc);
     ...
     */
    get registry() {
        return tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f");
    }
    /**
     * @description Creates an instance of a type as registered
     */
    createType(type, ...params) {
        return tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f").createType(type, ...params);
    }
    /**
     * @description Register additional user-defined of chain-specific types in the type registry
     */
    registerTypes(types) {
        types && tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f").register(types);
    }
    /**
    ...
    injectMetadata(metadata, fromEmpty, registry) {
        this._injectMetadata({ counter: 0, metadata, registry: registry || tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f"), runtimeVersion: tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f").createType('RuntimeVersionPartial') }, fromEmpty);
    }
    ...
    _decorateCalls({ registry, runtimeVersion: { apis, specName, specVersion } }, decorateMethod, blockHash) {
        ...
        const hasLogged = tslib_1.__classPrivateFieldGet(this, _Decorate_runtimeLog, "f")[implName] || false;
        tslib_1.__classPrivateFieldGet(this, _Decorate_runtimeLog, "f")[implName] = true;
        for (let i = 0; i < sections.length; i++) {
    ...
    _decorateStorageEntry(creator, decorateMethod) {
        const getArgs = (args, registry) => (0, validate_js_1.extractStorageArgs)(registry || tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f"), creator, args);
        ...
        if (creator.iterKey && creator.meta.type.isMap) {
            decorated.entries = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (...args) => this._retrieveMapEntries(creator, null, args)));
            // eslint-disable-next-line deprecation/deprecation
            decorated.entriesAt = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (blockHash, ...args) => getQueryAt(blockHash).pipe((0, rxjs_1.switchMap)((q) => this._retrieveMapEntries(q.creator, blockHash, args)))));
            decorated.entriesPaged = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (opts) => this._retrieveMapEntriesPaged(creator, undefined, opts)));
            decorated.keys = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (...args) => this._retrieveMapKeys(creator, null, args)));
            // eslint-disable-next-line deprecation/deprecation
            decorated.keysAt = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (blockHash, ...args) => getQueryAt(blockHash).pipe((0, rxjs_1.switchMap)((q) => this._retrieveMapKeys(q.creator, blockHash, args)))));
            decorated.keysPaged = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (opts) => this._retrieveMapKeysPaged(creator, undefined, opts)));
        }
    ...
    _decorateStorageEntryAt(registry, creator, decorateMethod, blockHash) {
        ...
        // .keys() & .entries() only available on map types
        if (creator.iterKey && creator.meta.type.isMap) {
            decorated.entries = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (...args) => this._retrieveMapEntries(creator, blockHash, args)));
            decorated.entriesPaged = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (opts) => this._retrieveMapEntriesPaged(creator, blockHash, opts)));
            decorated.keys = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (...args) => this._retrieveMapKeys(creator, blockHash, args)));
            decorated.keysPaged = decorateMethod((0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (opts) => this._retrieveMapKeysPaged(creator, blockHash, opts)));
        }
        if (this.supportMulti && creator.meta.type.isMap) {
            // When using double map storage function, user need to pass double map key as an array
            decorated.multi = decorateMethod((args) => creator.meta.type.asMap.hashers.length === 1
    ...
    _queueStorage(call, queue) {
        const query = queue === tslib_1.__classPrivateFieldGet(this, _Decorate_storageSubQ, "f")
            ? this._rpcCore.state.subscribeStorage
    ...
    _decorateStorageCall(creator, decorateMethod) {
        const memoed = (0, rpc_core_1.memo)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), (...args) => {
            const call = (0, validate_js_1.extractStorageArgs)(tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f"), creator, args);
            if (!this.hasSubscriptions) {
                return this._rpcCore.state.getStorage(call);
            }
            return this._queueStorage(call, tslib_1.__classPrivateFieldGet(this, _Decorate_storageSubQ, "f"));
        });
        return decorateMethod(memoed, {
            methodName: creator.method,
            overrideNoSub: (...args) => this._queueStorage((0, validate_js_1.extractStorageArgs)(tslib_1.__classPrivateFieldGet(this, _Decorate_registry, "f"), creator, args), tslib_1.__classPrivateFieldGet(this, _Decorate_storageGetQ, "f"))
        });
    }
    ...
    _decorateDeriveRx(decorateMethod) {
        ...
        const available = (0, api_derive_1.getAvailableDerives)(tslib_1.__classPrivateFieldGet(this, _Decorate_instanceId, "f"), this._rx, (0, util_1.objectSpread)({}, this._options.derives, this._options.typesBundle?.spec?.[specName || '']?.derives));
