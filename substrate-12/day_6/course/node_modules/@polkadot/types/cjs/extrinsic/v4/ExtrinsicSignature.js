...
class GenericExtrinsicSignatureV4 extends types_codec_1.Struct {
    constructor(registry, value, { isSigned } = {}) {
        ...
        tslib_1.__classPrivateFieldSet(this, _GenericExtrinsicSignatureV4_signKeys, Object.keys(signTypes), "f");
        (0, util_1.objectProperties)(this, tslib_1.__classPrivateFieldGet(this, _GenericExtrinsicSignatureV4_signKeys, "f"), (k) => this.get(k));
    }
    /** @internal */
    ...
    _injectSignature(signer, signature, payload) {
        ...
        for (let i = 0; i < tslib_1.__classPrivateFieldGet(this, _GenericExtrinsicSignatureV4_signKeys, "f").length; i++) {
            const k = tslib_1.__classPrivateFieldGet(this, _GenericExtrinsicSignatureV4_signKeys, "f")[i];
